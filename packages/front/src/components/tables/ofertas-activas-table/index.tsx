...
import { useOfertasActivasTableStore } from "./store";
...
interface OfertasActivasTableProps {
  // Add any props if needed in the future
}

export function OfertasActivasTable({}: OfertasActivasTableProps) {
