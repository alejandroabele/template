...
interface AppState {
    ...
    recursoId?: number | null;  // Agregamos recursoId aquí
    ...
    setRecursoId: (id: number | null) => void;  // Setter para recursoId
...
export const useStore = create<AppState>()(
    persist(
        ...
        {
            name: 'proveedor-state',  // Persistimos el estado en localStorage
