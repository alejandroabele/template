...
import { useCreateAreaMutation, useEditAreaMutation } from '@/hooks/area'
...
export default function MyForm({ data }: MyFormProps) {
    ...
    const { mutateAsync: create, isPending: isPendingCreate } = useCreateAreaMutation()
    const { mutateAsync: edit, isPending: isPendingEdit } = useEditAreaMutation()
