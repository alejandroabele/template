...
export const ESTADO_ORDEN_COMPRA_CODIGOS = {
  ...
  OC_RECEPCIONADA_PARCIAL: 'OC_RECEPCIONADA_PARCIAL',
} as const;

// Constantes para los tipos de aprobación de ofertas
export const APROBACION_OFERTA_TIPO_CODIGOS = {
  APROB_TEC: 'APROB_TEC', // Aprobación Técnica
  APROB_CAL: 'APROB_CAL', // Aprobación de Calidad
  APROB_GER: 'APROB_GER', // Aprobación de Gerencia
  APROB_ADM: 'APROB_ADM', // Aprobación de Administración y Finanzas
} as const;
